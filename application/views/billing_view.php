...
<html>
    <head>
        ...
        <link rel="shortcut icon" type="image/icon" href="<?php echo base_url(); ?>images/billing.ico" />
    </head>
    <body>
        <div id="bill_info">
            ...
            <form name="billing" method="post" action="<?php echo base_url() . 'index.php/shopping/save_order' ?>" >
                ...
                <div align="center">
                    ...
                    <table border="0" cellpadding="2px">
                        <tr><td>Order Total:</td><td><strong>KES <?php echo number_format($grand_total, 2); ?></strong></td></tr>
